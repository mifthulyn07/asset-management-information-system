...
Public Class CRLaporanAnggota
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SimAset_SMPN26Medan.CRLaporanAnggota.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRLaporanAnggota
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRLaporanAnggota = New CRLaporanAnggota()
        rpt.Site = Me.Site
        Return rpt
    End Function
